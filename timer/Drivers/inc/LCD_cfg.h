...
/* LCD Data Pins */
#define LCD_PIN_D0  DIO_PORTC,DIO_PIN7
#define LCD_PIN_D1  DIO_PORTC,DIO_PIN6
#define LCD_PIN_D2  DIO_PORTC,DIO_PIN5
#define LCD_PIN_D3  DIO_PORTC,DIO_PIN4
#define LCD_PIN_D4  DIO_PORTC,DIO_PIN3
#define LCD_PIN_D5  DIO_PORTC,DIO_PIN2
#define LCD_PIN_D6  DIO_PORTC,DIO_PIN1
#define LCD_PIN_D7  DIO_PORTC,DIO_PIN0
