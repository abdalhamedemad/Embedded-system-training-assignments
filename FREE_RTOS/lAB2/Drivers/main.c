...
#include "EEPROM.h"
#include "WDT.h"
#include "./New folder/FREE_RTOS/FreeRTOSConfig.h"
#include "./New folder/FREE_RTOS/FreeRTOS.h"
...
//		EEPROM_Write_Byte(0b10100000,0b00000000,4);
//		_delay_ms(1000);
//		STATE = EEPROM_Read_Byte(0b10100000,0b00000000);
//		_delay_ms(1000);
//		if(STATE == 4)
//		{
//			DIO_SetPinLevel(DIO_PORTA,DIO_PIN0,DIO_HIGH);
...
//  }
 ...
 //	 DIO_SetPinMode(DIO_PORTD,DIO_PIN5,DIO_OUTPUT);
     ...
     //  }
 	 ...
 	 //    DIO_SetPinLevel(DIO_PORTB,DIO_PIN0,DIO_HIGH);
 	 //    _delay_ms(1000);
//     Gpt_ConfigType config = {GPT_CHANNEL_TIMER0, SPT_MODE_Fast_PWM, GPT_OUTPUT_CLEAR, GPT_PRESCALER_1024};
...
//     DIO_SetPinMode(DIO_PORTB,DIO_PIN0,DIO_OUTPUT);
//     Gpt_Init(&config);
